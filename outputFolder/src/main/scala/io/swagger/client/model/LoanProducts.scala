...
case class LoanProducts (
  ...
  groupProduct: Option[LoanProductsGroupProduct] = None,
  /* Годовая ставка */
  ...
  agreementRole: Option[LoanProductsAgreementRole] = None,
  /* Статус */
  state: Option[LoanProductsEnums.State] = None
) extends ApiModel

object LoanProductsEnums {
