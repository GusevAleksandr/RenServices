...
object PartnerEmployeeListApi {
   ...
   *   Bearer (apiKey)
   * 
   * @param queryId идентификатор сохраненных параметров запроса не сервере приложений, возвращенных ранее при вызове метода post на урл /rest-api/list/partnerEmployee
   ...
   */
  def getPartnerEmployeeList(queryId: String, page: Option[Int] = None, pageSize: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[PartnerEmployee]] =
    ApiRequest[Seq[PartnerEmployee]](ApiMethods.GET, "https://virtserver.swaggerhub.com/renessansBankService/restServices/1.0.0", "/rest-api/list/partnerEmployee/{queryId}", "application/json")
   ...
   */
  def postPartnerEmployeesList(body: DocListRequest)(implicit apiKey: ApiKeyValue): ApiRequest[String] =
